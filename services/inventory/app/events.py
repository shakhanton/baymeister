...
`procurement` за `stock.low` формує чернетку замовлення постачальнику;
`analytics` за `stock.issued` рахує собівартість нарядів; `stock.discrepancy`
— сигнал на інвентаризацію: наряд закрито, а деталей на складі менше.
