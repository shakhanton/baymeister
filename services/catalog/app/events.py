...
`work-orders` бере ціну в момент додавання роботи чи запчастини й зберігає її
в наряді — тому подій про ціни він не слухає. Їх слухає `analytics` (динаміка
цін) і `documents` (актуальний прайс для друку).
