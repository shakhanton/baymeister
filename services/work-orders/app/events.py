...
Від нарядів залежить половина системи: `order.completed` — `finance` створює
рахунок, `payroll` нараховує механікам, `analytics` оновлює виручку;
`parts.reserved` — `inventory` списує з вільного залишку.
