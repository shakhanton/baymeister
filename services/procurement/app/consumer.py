...
Черга власна й довговічна (`procurement.events`): поки сервіс лежить, сигнали
складу накопичуються й доходять після старту. Підтвердження —
...
async def start() -> None:
    ...
    if not settings.rabbitmq_url:
        logger.warning("RABBITMQ_URL не заданий — сигнали складу не надходитимуть")
        return
